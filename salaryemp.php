	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="addemp.php">Add Player</a></li>
				<li><a class="homeblack" href="viewemp.php">View Player</a></li>
				<li><a class="homeblack" href="assign.php">Assign Project</a></li>
				<li><a class="homeblack" href="assignproject.php">Project Status</a></li>
				<li><a class="homered" href="salaryemp.php">Salary Table</a></li>
				<li><a class="homeblack" href="empleave.php">Player Leave</a></li>
